...
const questions = [
  ...
  {
    type: "image",
    question: "어느 것이 셔츠 입니까 ?",
    questionFa: "کدوم یکی پیراهن هست؟",
    speak: "셔츠",
    options: [
      { text: "바지", image: "../../media/clothes/pants.png" },
      { text: "셔츠", image: "../../media/clothes/shirt.png" },
      { text: "모자", image: "../../media/clothes/hat.png" },
      { text: "드레스", image: "../../media/clothes/dress.png" }
    ],
    answer: "셔츠"
  },
  {
    type: "image",
    question: "어느 것이 바지 입니까 ?",
    questionFa: "کدوم یکی شلوار هست؟",
    speak: "바지",
    options: [
      { text: "드레스", image: "../../media/clothes/dress.png" },
      { text: "바지", image: "../../media/clothes/pants.png" },
      { text: "신발", image: "../../media/clothes/shoes.png" },
      { text: "셔츠", image: "../../media/clothes/shirt.png" }
    ],
    answer: "바지"
  },
...
window.onload = function() {
  ...
  if (backBtn) {
    backBtn.addEventListener("click", () => {
      ...
      const lesson = params.get("lesson") || "ko-lesson4";
