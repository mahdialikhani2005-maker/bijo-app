...
const questions = [
  ...
  {
    type: "image",
    question: "어느 것이 해 입니까 ?",
    questionFa: "کدوم یکی خورشید هست؟",
    speak: "해",
    options: [
      { text: "달", image: "../../media/nature/moon.png" },
      { text: "해", image: "../../media/nature/sun.png" },
      { text: "별", image: "../../media/nature/star.png" },
      { text: "하늘", image: "../../media/nature/sky.png" }
    ],
    answer: "해"
  },
  {
    type: "image",
    question: "어느 것이 달 입니까 ?",
    questionFa: "کدوم یکی ماه هست؟",
    speak: "달",
    options: [
      { text: "별", image: "../../media/nature/star.png" },
      { text: "달", image: "../../media/nature/moon.png" },
      { text: "비", image: "../../media/nature/rain.png" },
      { text: "해", image: "../../media/nature/sun.png" }
    ],
    answer: "달"
  },
...
window.onload = function() {
  ...
  if (backBtn) {
    backBtn.addEventListener("click", () => {
      ...
      const lesson = params.get("lesson") || "ko-lesson9";
