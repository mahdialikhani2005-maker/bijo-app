...
const questions = [
  ...
  {
    type: "image",
    question: "어느 것이 빨간색 입니까 ?",
    questionFa: "کدوم یکی قرمز هست؟",
    speak: "빨간색",
    options: [
      { text: "파란색", image: "../../media/colors/blue.png" },
      { text: "빨간색", image: "../../media/colors/red.png" },
      { text: "초록색", image: "../../media/colors/green.png" },
      { text: "노란색", image: "../../media/colors/yellow.png" }
    ],
    answer: "빨간색"
  },
  {
    type: "image",
    question: "어느 것이 파란색 입니까 ?",
    questionFa: "کدوم یکی آبی هست؟",
    speak: "파란색",
    options: [
      { text: "노란색", image: "../../media/colors/yellow.png" },
      { text: "파란색", image: "../../media/colors/blue.png" },
      { text: "검은색", image: "../../media/colors/black.png" },
      { text: "빨간색", image: "../../media/colors/red.png" }
    ],
    answer: "파란색"
  },
...
window.onload = function() {
  ...
  if (backBtn) {
    backBtn.addEventListener("click", () => {
      ...
      const lesson = params.get("lesson") || "ko-lesson11";
