...
const questions = [
  ...
  {
    type: "image",
    question: "어느 것이 머리 입니까 ?",
    questionFa: "کدوم یکی سر هست؟",
    speak: "머리",
    options: [
      { text: "손", image: "../../media/body/hand.png" },
      { text: "머리", image: "../../media/body/head.png" },
      { text: "눈", image: "../../media/body/eye.png" },
      { text: "코", image: "../../media/body/nose.png" }
    ],
    answer: "머리"
  },
  {
    type: "image",
    question: "어느 것이 손 입니까 ?",
    questionFa: "کدوم یکی دست هست؟",
    speak: "손",
    options: [
      { text: "눈", image: "../../media/body/eye.png" },
      { text: "손", image: "../../media/body/hand.png" },
      { text: "발", image: "../../media/body/foot.png" },
      { text: "머리", image: "../../media/body/head.png" }
    ],
    answer: "손"
  },
...
window.onload = function() {
  ...
  if (backBtn) {
    backBtn.addEventListener("click", () => {
      ...
      const lesson = params.get("lesson") || "ko-lesson2";
