...
const questions = [
  ...
  {
    type: "image",
    question: "어느 것이 개 입니까 ?",
    questionFa: "کدوم یکی سگ هست؟",
    speak: "개",
    options: [
      { text: "고양이", image: "../../media/animals/cat.png" },
      { text: "개", image: "../../media/animals/dog.png" },
      { text: "새", image: "../../media/animals/bird.png" },
      { text: "물고기", image: "../../media/animals/fish.png" }
    ],
    answer: "개"
  },
  {
    type: "image",
    question: "어느 것이 고양이 입니까 ?",
    questionFa: "کدوم یکی گربه هست؟",
    speak: "고양이",
    options: [
      { text: "물고기", image: "../../media/animals/fish.png" },
      { text: "고양이", image: "../../media/animals/cat.png" },
      { text: "말", image: "../../media/animals/horse.png" },
      { text: "개", image: "../../media/animals/dog.png" }
    ],
    answer: "고양이"
  },
...
window.onload = function() {
  ...
  if (backBtn) {
    backBtn.addEventListener("click", () => {
      ...
      const lesson = params.get("lesson") || "ko-lesson8";
