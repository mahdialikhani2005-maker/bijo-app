...
const questions = [
  ...
  {
    type: "image",
    question: "welches ist eins ?",
    questionFa: "کدوم یکی یک هست؟",
    speak: "eins",
    options: [
      { text: "zwei", image: "../../media/numbers/two.png" },
      { text: "eins", image: "../../media/numbers/one.png" },
      { text: "drei", image: "../../media/numbers/three.png" },
      { text: "vier", image: "../../media/numbers/four.png" }
    ],
    answer: "eins"
  },
  {
    type: "image",
    question: "welches ist zwei ?",
    questionFa: "کدوم یکی دو هست؟",
    speak: "zwei",
    options: [
      { text: "vier", image: "../../media/numbers/four.png" },
      { text: "zwei", image: "../../media/numbers/two.png" },
      { text: "fünf", image: "../../media/numbers/five.png" },
      { text: "eins", image: "../../media/numbers/one.png" }
    ],
    answer: "zwei"
  },
  ...
  {
    type: "build-de",
    speak: "Ich habe ein Buch",
    question: "Bauen Sie den deutschen Satz:",
    questionFa: "جمله آلمانی رو بساز:",
    text: "من یک کتاب دارم",
    words: ["ein", "Buch", "habe", "Ich"],
    answer: ["Ich", "habe", "ein", "Buch"]
  },
  {
    type: "build-de",
    speak: "Ich habe zwei Bücher",
    question: "Bauen Sie den deutschen Satz:",
    questionFa: "جمله آلمانی رو بساز:",
    text: "من دو کتاب دارم",
    words: ["zwei", "Bücher", "habe", "Ich"],
    answer: ["Ich", "habe", "zwei", "Bücher"]
  },
  {
    type: "build-de",
    speak: "Ich habe drei Bücher",
    question: "Bauen Sie den deutschen Satz:",
    questionFa: "جمله آلمانی رو بساز:",
    text: "من سه کتاب دارم",
    words: ["drei", "Bücher", "habe", "Ich"],
    answer: ["Ich", "habe", "drei", "Bücher"]
  },
  {
    type: "build-de",
    speak: "Ich habe vier Bücher",
    question: "Bauen Sie den deutschen Satz:",
    questionFa: "جمله آلمانی رو بساز:",
    text: "من چهار کتاب دارم",
    words: ["vier", "Bücher", "habe", "Ich"],
    answer: ["Ich", "habe", "vier", "Bücher"]
  },
  {
    type: "build-de",
    speak: "Ich habe fünf Bücher",
    question: "Bauen Sie den deutschen Satz:",
    questionFa: "جمله آلمانی رو بساز:",
    text: "من پنج کتاب دارم",
    words: ["fünf", "Bücher", "habe", "Ich"],
    answer: ["Ich", "habe", "fünf", "Bücher"]
  },
...
window.onload = function() {
  ...
  if (backBtn) {
    backBtn.addEventListener("click", () => {
      ...
      const lesson = params.get("lesson") || "de-lesson12";
