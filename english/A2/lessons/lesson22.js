...
const questions = [
  ...
  {
    type: 'image',
    question: 'pizza کدام است؟',
    speak: 'pizza',
    options: [
      { text: 'pasta', image: '../../../media/a2/food/pasta.png' },
      { text: 'pizza', image: '../../../media/a2/food/pizza.png' },
      { text: 'salad', image: '../../../media/a2/food/salad.png' },
  ...
  // ===== بخش ۲: WORD (۵ تا) =====
  {
    ...
    options: ['pasta', 'pizza', 'salad', 'sandwich'],
    answer: 'pizza'
  },
  {
    type: 'word',
    ...
    options: ['sandwich', 'pasta', 'burger', 'pizza'],
    answer: 'pasta'
  },
  {
    type: 'word',
    ...
    options: ['pizza', 'salad', 'burger', 'pasta'],
    answer: 'salad'
  },
  {
    type: 'word',
  ...
  },
  {
    ...
    options: ['salad', 'pizza', 'burger', 'pasta'],
    answer: 'burger'
  },
  ...
  // ===== بخش ۳: AUDIO (۵ تا) =====
  {
    ...
    options: ['pizza', 'pasta', 'salad', 'sandwich'],
    answer: 'pizza'
  },
  {
    type: 'audio',
  ...
  {
    type: 'build-en',
    speak: 'I eat a sandwich',
    question: 'جمله انگلیسی را بساز:',
    text: 'من یک ساندویچ می‌خورم',
    words: ['sandwich', 'a', 'eat', 'I'],
    answer: ['I', 'eat', 'a', 'sandwich']
  },
  {
    type: 'build-en',
    speak: 'I eat a burger',
    question: 'جمله انگلیسی را بساز:',
    text: 'من یک برگر می‌خورم',
    words: ['burger', 'a', 'eat', 'I'],
    answer: ['I', 'eat', 'a', 'burger']
  },
