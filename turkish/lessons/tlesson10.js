...
const questions = [
  ...
  {
    type: "image",
    question: "hangisi sıcak ?",
    questionFa: "کدوم یکی گرم هست؟",
    speak: "sıcak",
    options: [
      { text: "soğuk", image: "../../media/weather/cold.png" },
      { text: "sıcak", image: "../../media/weather/hot.png" },
      { text: "güneşli", image: "../../media/weather/sunny.png" },
      { text: "bulutlu", image: "../../media/weather/cloudy.png" }
    ],
    answer: "sıcak"
  },
  {
    type: "image",
    question: "hangisi soğuk ?",
    questionFa: "کدوم یکی سرد هست؟",
    speak: "soğuk",
    options: [
      { text: "güneşli", image: "../../media/weather/sunny.png" },
      { text: "soğuk", image: "../../media/weather/cold.png" },
      { text: "rüzgâr", image: "../../media/weather/wind.png" },
      { text: "sıcak", image: "../../media/weather/hot.png" }
    ],
    answer: "soğuk"
  },
  ...
  },
  {
    ...
    options: ["güneşli", "soğuk", "rüzgâr", "sıcak"],
    answer: "soğuk"
  },
  {
    type: "word",
    ...
    options: ["sıcak", "güneşli", "rüzgâr", "soğuk"],
    answer: "güneşli"
  },
  {
    type: "word",
  ...
  },
  {
    ...
    options: ["bulutlu", "sıcak", "soğuk", "rüzgâr"],
    answer: "rüzgâr"
  },
...
window.onload = function() {
  ...
  if (backBtn) {
    backBtn.addEventListener("click", () => {
      ...
      const lesson = params.get("lesson") || "tr-lesson10";
