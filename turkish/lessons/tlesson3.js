...
const questions = [
  // -------- IMAGE SELECTION --------
  {
    type: "image",
    question: "hangisi ev ?",
    questionFa: "کدوم یکی خونه هست؟",
    speak: "ev",
    options: [
      { text: "oda", image: "../../media/house/room.png" },
      { text: "ev", image: "../../media/house/house.png" },
      { text: "kapı", image: "../../media/house/door.png" },
      { text: "pencere", image: "../../media/house/window.png" }
    ],
    answer: "ev"
  },
  {
    type: "image",
    question: "hangisi oda ?",
    questionFa: "کدوم یکی اتاق هست؟",
    speak: "oda",
    options: [
      { text: "pencere", image: "../../media/house/window.png" },
      { text: "oda", image: "../../media/house/room.png" },
      { text: "mutfak", image: "../../media/house/kitchen.png" },
      { text: "ev", image: "../../media/house/house.png" }
    ],
    answer: "oda"
  },
  ...
  {
    type: "build-tr",
    speak: "Bu bir pencere",
    question: "Türkçe cümleyi kur:",
    questionFa: "جمله ترکی رو بساز:",
    text: "این یک پنجره است",
    words: ["pencere", "bir", "Bu"],
    answer: ["Bu", "bir", "pencere"]
  },
  {
    type: "build-tr",
    speak: "Bu bir mutfak",
...
window.onload = function() {
  ...
  if (backBtn) {
    backBtn.addEventListener("click", () => {
      ...
      const lesson = params.get("lesson") || "tr-lesson3";
