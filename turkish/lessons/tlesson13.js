...
const questions = [
  ...
  {
    type: "image",
    question: "hangisi bugün ?",
    questionFa: "کدوم یکی امروز هست؟",
    speak: "bugün",
    options: [
      { text: "yarın", image: "../../media/time/tomorrow.png" },
      { text: "bugün", image: "../../media/time/today.png" },
      { text: "dün", image: "../../media/time/yesterday.png" },
      { text: "sabah", image: "../../media/time/morning.png" }
    ],
    answer: "bugün"
  },
  {
    type: "image",
    question: "hangisi yarın ?",
    questionFa: "کدوم یکی فردا هست؟",
    speak: "yarın",
    options: [
      { text: "gece", image: "../../media/time/night.png" },
      { text: "yarın", image: "../../media/time/tomorrow.png" },
      { text: "bugün", image: "../../media/time/today.png" },
      { text: "dün", image: "../../media/time/yesterday.png" }
    ],
...
window.onload = function() {
  ...
  if (backBtn) {
    backBtn.addEventListener("click", () => {
      ...
      const lesson = params.get("lesson") || "tr-lesson13";
