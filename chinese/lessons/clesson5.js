...
const questions = [
  // -------- IMAGE SELECTION --------
  {
    ...
    speak: "miànbāo",
    options: [
      { text: "米饭", image: "../../media/food/rice.png" },
      { text: "面包", image: "../../media/food/bread.png" },
      { text: "肉", image: "../../media/food/meat.png" },
      { text: "鸡蛋", image: "../../media/food/egg.png" }
    ],
    answer: "面包"
  },
  {
    ...
    options: [
      { text: "鸡蛋", image: "../../media/food/egg.png" },
      { text: "米饭", image: "../../media/food/rice.png" },
      { text: "牛奶", image: "../../media/food/milk.png" },
      { text: "面包", image: "../../media/food/bread.png" }
    ],
    answer: "米饭"
  },
...
window.onload = function() {
  ...
  if (backBtn) {
    backBtn.addEventListener("click", () => {
      ...
      const lesson = params.get("lesson") || "zh-lesson5";
