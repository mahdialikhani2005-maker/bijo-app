...
const questions = [
  // -------- IMAGE SELECTION --------
  {
    ...
    speak: "hoy",
    options: [
      { text: "mañana (mañana)", image: "../../media/time/tomorrow.png" },
      { text: "hoy", image: "../../media/time/today.png" },
      { text: "ayer", image: "../../media/time/yesterday.png" },
      { text: "mañana (día)", image: "../../media/time/morning.png" }
    ],
    answer: "hoy"
  },
  {
    type: "image",
    question: "¿cuál es mañana (futuro) ?",
    questionFa: "کدوم یکی فردا هست؟",
    speak: "mañana",
    options: [
      { text: "noche", image: "../../media/time/night.png" },
      { text: "mañana (futuro)", image: "../../media/time/tomorrow.png" },
      { text: "hoy", image: "../../media/time/today.png" },
      { text: "ayer", image: "../../media/time/yesterday.png" }
    ],
  ...
  },
  {
    ...
    words: ["Mañana (futuro)", "es", "martes"],
    answer: ["Mañana (futuro)", "es", "martes"]
  },
  {
    type: "build-es",
...
window.onload = function() {
  ...
  if (backBtn) {
    backBtn.addEventListener("click", () => {
      ...
      const lesson = params.get("lesson") || "es-lesson13";
