...
const questions = [
  ...
  {
    type: "image",
    question: "какой из них есть ?",
    questionFa: "کدوم یکی خوردن هست؟",
    speak: "есть",
    options: [
      { text: "спать", image: "../../media/actions/sleep.png" },
      { text: "есть", image: "../../media/actions/eat.png" },
      { text: "гулять", image: "../../media/actions/walk.png" },
      { text: "читать", image: "../../media/actions/read.png" }
    ],
    answer: "есть"
  },
  {
    type: "image",
    question: "какой из них спать ?",
    questionFa: "کدوم یکی خوابیدن هست؟",
    speak: "спать",
    options: [
      { text: "писать", image: "../../media/actions/write.png" },
      { text: "спать", image: "../../media/actions/sleep.png" },
      { text: "есть", image: "../../media/actions/eat.png" },
      { text: "гулять", image: "../../media/actions/walk.png" }
    ],
  ...
  // -------- WORD FROM IMAGE --------
  {
    ...
    options: ["спать", "есть", "гулять", "читать"],
    answer: "есть"
  },
  {
    type: "word",
    ...
    options: ["писать", "спать", "есть", "гулять"],
    answer: "спать"
  },
  {
    type: "word",
    ...
    options: ["есть", "гулять", "писать", "спать"],
    answer: "гулять"
  },
  {
    type: "word",
    ...
    options: ["гулять", "спать", "читать", "есть"],
    answer: "читать"
  },
  {
    type: "word",
  ...
  {
    type: "build-ru",
    speak: "Я гуляю в школу",
    question: "Составьте русское предложение:",
    questionFa: "جمله روسی رو بساز:",
    text: "من به مدرسه راه می‌روم",
    words: ["гуляю", "школу", "в", "Я"],
    answer: ["Я", "гуляю", "в", "школу"]
  },
  {
    type: "build-ru",
    speak: "Я читаю книгу",
...
window.onload = function() {
  ...
  if (backBtn) {
    backBtn.addEventListener("click", () => {
      ...
      const lesson = params.get("lesson") || "ru-lesson18";
