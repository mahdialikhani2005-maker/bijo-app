...
const questions = [
  ...
  {
    type: "image",
    question: "какой из них красный ?",
    questionFa: "کدوم یکی قرمز هست؟",
    speak: "красный",
    options: [
      { text: "синий", image: "../../media/colors/blue.png" },
      { text: "красный", image: "../../media/colors/red.png" },
      { text: "зелёный", image: "../../media/colors/green.png" },
      { text: "жёлтый", image: "../../media/colors/yellow.png" }
    ],
    answer: "красный"
  },
  {
    type: "image",
    question: "какой из них синий ?",
    questionFa: "کدوم یکی آبی هست؟",
    speak: "синий",
    options: [
      { text: "жёлтый", image: "../../media/colors/yellow.png" },
      { text: "синий", image: "../../media/colors/blue.png" },
      { text: "чёрный", image: "../../media/colors/black.png" },
      { text: "красный", image: "../../media/colors/red.png" }
    ],
    answer: "синий"
  },
...
window.onload = function() {
  ...
  if (backBtn) {
    backBtn.addEventListener("click", () => {
      ...
      const lesson = params.get("lesson") || "ru-lesson11";
