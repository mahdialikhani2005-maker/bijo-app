...
const questions = [
  ...
  {
    type: "image",
    question: "qual è insegnante ?",
    questionFa: "کدوم یکی معلم هست؟",
    speak: "insegnante",
    options: [
      { text: "medico", image: "../../media/jobs/doctor.png" },
      { text: "insegnante", image: "../../media/jobs/teacher.png" },
      { text: "ingegnere", image: "../../media/jobs/engineer.png" },
      { text: "studente", image: "../../media/jobs/student.png" }
    ],
    answer: "insegnante"
  },
  {
    type: "image",
    question: "qual è medico ?",
    questionFa: "کدوم یکی دکتر هست؟",
    speak: "medico",
    options: [
      { text: "studente", image: "../../media/jobs/student.png" },
      { text: "medico", image: "../../media/jobs/doctor.png" },
      { text: "autista", image: "../../media/jobs/driver.png" },
      { text: "insegnante", image: "../../media/jobs/teacher.png" }
    ],
    answer: "medico"
  },
  ...
  // -------- WORD FROM IMAGE --------
  {
    ...
    options: ["medico", "insegnante", "ingegnere", "studente"],
    answer: "insegnante"
  },
  {
    type: "word",
    ...
    options: ["studente", "medico", "autista", "insegnante"],
    answer: "medico"
  },
  {
    type: "word",
    ...
    options: ["insegnante", "ingegnere", "autista", "medico"],
    answer: "ingegnere"
  },
  {
    type: "word",
    ...
    options: ["ingegnere", "medico", "studente", "insegnante"],
    answer: "studente"
  },
  {
    type: "word",
    ...
    options: ["studente", "insegnante", "medico", "autista"],
    answer: "autista"
  },
...
window.onload = function() {
  ...
  if (backBtn) {
    backBtn.addEventListener("click", () => {
      ...
      const lesson = params.get("lesson") || "it-lesson14";
