...
const questions = [
  ...
  {
    type: "image",
    question: "qual è casa ?",
    questionFa: "کدوم یکی خانه هست؟",
    speak: "casa",
    options: [
      { text: "camera", image: "../../media/house/room.png" },
      { text: "casa", image: "../../media/house/house.png" },
      { text: "porta", image: "../../media/house/door.png" },
      { text: "finestra", image: "../../media/house/window.png" }
    ],
    answer: "casa"
  },
  {
    type: "image",
    question: "qual è camera ?",
    questionFa: "کدوم یکی اتاق هست؟",
    speak: "camera",
    options: [
      { text: "finestra", image: "../../media/house/window.png" },
      { text: "camera", image: "../../media/house/room.png" },
      { text: "cucina", image: "../../media/house/kitchen.png" },
      { text: "casa", image: "../../media/house/house.png" }
    ],
    answer: "camera"
  },
  ...
  // -------- WORD FROM IMAGE --------
  {
    ...
    options: ["camera", "casa", "porta", "finestra"],
    answer: "casa"
  },
  {
    type: "word",
    ...
    options: ["finestra", "camera", "cucina", "casa"],
    answer: "camera"
  },
  {
    type: "word",
    ...
    options: ["casa", "porta", "finestra", "camera"],
    answer: "porta"
  },
  {
    type: "word",
    ...
    options: ["porta", "casa", "finestra", "camera"],
    answer: "finestra"
  },
  {
    type: "word",
    ...
    options: ["camera", "finestra", "casa", "cucina"],
    answer: "cucina"
  },
  ...
  // -------- BUILD IT (ساختن جمله ایتالیایی) --------
  {
    ...
    words: ["casa", "una", "è", "Questa"],
    answer: ["Questa", "è", "una", "casa"]
  },
  {
    type: "build-it",
    speak: "Questa è una camera",
    question: "Costruisci la frase in italiano:",
    questionFa: "جمله ایتالیایی رو بساز:",
    text: "این یک اتاق است",
    words: ["camera", "una", "è", "Questa"],
    answer: ["Questa", "è", "una", "camera"]
  },
  {
    type: "build-it",
    speak: "Questa è una porta",
    question: "Costruisci la frase in italiano:",
    questionFa: "جمله ایتالیایی رو بساز:",
    text: "این یک در است",
    words: ["porta", "una", "è", "Questa"],
    answer: ["Questa", "è", "una", "porta"]
  },
  {
    type: "build-it",
    speak: "Questa è una finestra",
    question: "Costruisci la frase in italiano:",
    questionFa: "جمله ایتالیایی رو بساز:",
    text: "این یک پنجره است",
    words: ["finestra", "una", "è", "Questa"],
    answer: ["Questa", "è", "una", "finestra"]
  },
  {
    type: "build-it",
    speak: "Questa è una cucina",
    question: "Costruisci la frase in italiano:",
    questionFa: "جمله ایتالیایی رو بساز:",
    text: "این یک آشپزخانه است",
    words: ["cucina", "una", "è", "Questa"],
    answer: ["Questa", "è", "una", "cucina"]
  },
...
window.onload = function() {
  ...
  if (backBtn) {
    backBtn.addEventListener("click", () => {
      ...
      const lesson = params.get("lesson") || "it-lesson3";
