...
const questions = [
  ...
  {
    type: "image",
    question: "lequel est école ?",
    questionFa: "کدوم یکی مدرسه هست؟",
    speak: "école",
    options: [
      { text: "hôpital", image: "../../media/places/hospital.png" },
      { text: "école", image: "../../media/places/school.png" },
      { text: "magasin", image: "../../media/places/store.png" },
      { text: "parc", image: "../../media/places/park.png" }
    ],
    answer: "école"
  },
  {
    type: "image",
    question: "lequel est hôpital ?",
    questionFa: "کدوم یکی بیمارستان هست؟",
    speak: "hôpital",
    options: [
      { text: "parc", image: "../../media/places/park.png" },
      { text: "hôpital", image: "../../media/places/hospital.png" },
      { text: "mosquée", image: "../../media/places/mosque.png" },
      { text: "école", image: "../../media/places/school.png" }
    ],
    answer: "hôpital"
  },
  ...
  // -------- BUILD FR (ساختن جمله فرانسوی) --------
  {
    ...
    words: ["école", "une", "est", "C'est"],
    answer: ["C'est", "une", "école"]
  },
  {
    type: "build-fr",
    speak: "C'est un hôpital",
    question: "Construisez la phrase française :",
    questionFa: "جمله فرانسوی رو بساز:",
    text: "این یک بیمارستان است",
    words: ["hôpital", "un", "est", "C'est"],
    answer: ["C'est", "un", "hôpital"]
  },
  {
    type: "build-fr",
    speak: "C'est un magasin",
    question: "Construisez la phrase française :",
    questionFa: "جمله فرانسوی رو بساز:",
    text: "این یک فروشگاه است",
    words: ["magasin", "un", "est", "C'est"],
    answer: ["C'est", "un", "magasin"]
  },
  {
    type: "build-fr",
    speak: "C'est un parc",
    ...
    words: ["parc", "un", "est", "C'est"],
    answer: ["C'est", "un", "parc"]
  },
  {
    type: "build-fr",
...
window.onload = function() {
  ...
  if (backBtn) {
    backBtn.addEventListener("click", () => {
      ...
      const lesson = params.get("lesson") || "fr-lesson16";
