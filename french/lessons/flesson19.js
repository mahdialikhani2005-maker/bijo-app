...
const questions = [
  ...
  {
    type: "image",
    question: "lequel est grand ?",
    questionFa: "کدوم یکی بزرگ هست؟",
    speak: "grand",
    options: [
      { text: "petit", image: "../../media/adjectives/small.png" },
      { text: "grand", image: "../../media/adjectives/big.png" },
      { text: "grand", image: "../../media/adjectives/tall.png" },
      { text: "court", image: "../../media/adjectives/short.png" }
    ],
    answer: "grand"
  },
  {
    type: "image",
    question: "lequel est petit ?",
    questionFa: "کدوم یکی کوچک هست؟",
    speak: "petit",
    options: [
      { text: "beau", image: "../../media/adjectives/beautiful.png" },
      { text: "petit", image: "../../media/adjectives/small.png" },
      { text: "grand", image: "../../media/adjectives/big.png" },
      { text: "grand", image: "../../media/adjectives/tall.png" }
    ],
  ...
  {
    type: "image",
    question: "lequel est grand (taille) ?",
  ...
  // -------- WORD FROM IMAGE --------
  {
    ...
    options: ["petit", "grand", "grand", "court"],
    answer: "grand"
  },
  {
    type: "word",
    ...
    options: ["beau", "petit", "grand", "grand"],
    answer: "petit"
  },
  {
    type: "word",
    ...
    options: ["grand", "grand", "beau", "petit"],
    answer: "grand"
  },
  {
    type: "word",
    ...
    options: ["grand", "petit", "court", "grand"],
    answer: "court"
  },
  {
    type: "word",
  ...
  {
    type: "build-fr",
    speak: "Elle est courte",
    question: "Construisez la phrase française :",
    questionFa: "جمله فرانسوی رو بساز:",
    text: "او کوتاه است",
    words: ["courte", "est", "Elle"],
    answer: ["Elle", "est", "courte"]
  },
  {
    type: "build-fr",
    speak: "Elle est belle",
    question: "Construisez la phrase française :",
    questionFa: "جمله فرانسوی رو بساز:",
    text: "او زیبا است",
    words: ["belle", "est", "Elle"],
...
window.onload = function() {
  ...
  if (backBtn) {
    backBtn.addEventListener("click", () => {
      ...
      const lesson = params.get("lesson") || "fr-lesson19";
