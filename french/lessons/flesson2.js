...
const questions = [
  ...
  {
    type: "image",
    question: "lequel est tête ?",
    questionFa: "کدوم یکی سر هست؟",
    speak: "tête",
    options: [
      { text: "main", image: "../../media/body/hand.png" },
      { text: "tête", image: "../../media/body/head.png" },
      { text: "œil", image: "../../media/body/eye.png" },
      { text: "nez", image: "../../media/body/nose.png" }
    ],
    answer: "tête"
  },
  {
    type: "image",
    question: "lequel est main ?",
    questionFa: "کدوم یکی دست هست؟",
    speak: "main",
    options: [
      { text: "œil", image: "../../media/body/eye.png" },
      { text: "main", image: "../../media/body/hand.png" },
      { text: "pied", image: "../../media/body/foot.png" },
      { text: "tête", image: "../../media/body/head.png" }
    ],
    answer: "main"
  },
...
window.onload = function() {
  ...
  if (backBtn) {
    backBtn.addEventListener("click", () => {
      ...
      const lesson = params.get("lesson") || "fr-lesson2";
