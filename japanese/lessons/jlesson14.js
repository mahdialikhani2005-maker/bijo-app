...
const questions = [
  // -------- IMAGE SELECTION --------
  {
    ...
    speak: "せんせい",
    options: [
      { text: "医者", image: "../../media/jobs/doctor.png" },
      { text: "先生", image: "../../media/jobs/teacher.png" },
      { text: "エンジニア", image: "../../media/jobs/engineer.png" },
  ...
  },
  {
    ...
    options: [
      { text: "学生", image: "../../media/jobs/student.png" },
      { text: "医者", image: "../../media/jobs/doctor.png" },
      { text: "運転手", image: "../../media/jobs/driver.png" },
      { text: "先生", image: "../../media/jobs/teacher.png" }
    ],
    answer: "医者"
  },
  ...
  {
    type: "build-ja",
    speak: "かのじょは エンジニア です",
    question: "日本語の文を作ってください:",
    questionFa: "جمله ژاپنی رو بساز:",
    text: "او یک مهندس است",
    words: ["エンジニア", "です", "かのじょは"],
    answer: ["かのじょは", "エンジニア", "です"]
  },
  {
    type: "build-ja",
    speak: "わたしは がくせい です",
...
window.onload = function() {
  ...
  if (backBtn) {
    backBtn.addEventListener("click", () => {
      ...
      const lesson = params.get("lesson") || "ja-lesson14";
